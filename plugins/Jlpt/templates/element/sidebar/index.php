    ...
    <div class="bg-light">
        <ul class="nav nav-pills d-flex justify-content-center aside-tab" role="tablist">
            <li class="nav-item mx-1" role="presentation">
                <button class="btn rounded-0 <?php echo in_array($this->getRequest()->getParam('controller'), ['Home', 'ManageSystem', 'Purchase', 'Config', 'Quoting', 'Orders', 'Expenses', 'Product']) ? 'active' : ''; ?>"
...
<!--            </li>-->
        ...
        <div class="tab-content">
            <div class="tab-pane fade <?php echo in_array($this->getRequest()->getParam('controller'), ['Home', 'ManageSystem', 'Purchase', 'Config', 'Quoting', 'Orders', 'Expenses', 'Product']) ? 'show active' : ''; ?>" id="pills-aside-main" role="tabpanel" aria-labelledby="pills-aside-main-tab" tabindex="0">
